...
import { ArchiveBoxArrowDownIcon, ArchiveBoxIcon, ArrowLeftOnRectangleIcon, UserIcon } from "@heroicons/react/24/outline";
...
const userNavigation = [
    [{ Icon: UserIcon, name: 'Mon compte', href: '/user/@me' }, { Icon: ArchiveBoxArrowDownIcon, show: (user) => hasPermission(user, PERMISSIONS.CREATE_REPORT), name: 'Rapport du Matin', href: '/user/@me?newMorningReport' }, { Icon: ArchiveBoxIcon, show: (user) => hasPermission(user, PERMISSIONS.CREATE_REPORT), name: 'Rapport du Soir', href: '/user/@me?newReport' }],
